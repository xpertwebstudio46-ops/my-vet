...
type Review = { id: string; rating: number; title: string | null; comment: string; status: 'PENDING' | 'APPROVED' | 'REJECTED' | 'DISPUTED'; reply: string | null; repliedAt: string | null; createdAt: string; practice: { id: string; name: string; slug: string } }
